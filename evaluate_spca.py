"""
SpCA 推理与评估脚本（对应 Algorithm 1 Part 2 & 3）
...
def parse_args():
    p = argparse.ArgumentParser(description="SpCA 推理与评估")
    p.add_argument("--ckpt",      type=str,   default=None,
                   help="Checkpoint 路径（默认 checkpoints_spca/best.pt）")
...
def main():
    ...
    if args.output is None: cfg.OUTPUT_DIR = "outputs_spca"
